<?php
    ...
    $postDeleting = $post->selectFromId($id);
    ...
    <div class="bg-white p-6 rounded-lg shadow-xl w-96">
        <form action="../../controllers/PostController.php" method="POST">
            ...
            <h5 class="text-lg text-gray-600 text-center mb-6">
                ¿Está seguro de eliminar la publicación? <span class="font-semibold text-red-500"><?php echo $postDeleting['id'] ?></span>?
            </h5>

            <input type="hidden" name="idPost" value="<?php $id ?>">

            <div class="flex justify-around space-x-4">
                <button type="submit" name="eliminarPublicacion" class="bg-red-500 text-white py-2 px-6 rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400">
                    Sí
                </button>
